	...
	public String chat(Model model, @ModelAttribute FormInputDTO dto) {
		try {
			...
			model.addAttribute("response", "\"\\n\\nGluten sensitivity is a condition in which ingestion\n" +
					"of gluten, a protein found in wheat, barley, and rye, causes a range of\n" +
					"symptoms, such as abdominal pain, bloating, diarrhea, and constipation.\n" +
					"People with gluten sensitivity have difficulty tolerating products which\n" +
					"contain gluten, but are not diagnosed with celiac disease.\",.");
		}
		return MAIN_PAGE;
	}
